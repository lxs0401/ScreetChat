...
public interface Function<F, T> {
  ...
  /**
   * Indicates whether another chatcore.chatCore.object is equal to this function.
   *
   * <p>Most implementations will have no reason to override the behavior of {@link Object#equals}.
   * However, an implementation may also choose to return {@code true} whenever {@code chatcore.chatCore.object} is a
