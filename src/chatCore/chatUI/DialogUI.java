...
import chatCore.dataBase.DialogDB;
import chatCore.dataBase.Figures;
import chatCore.object.CloseButton;
	...
	public DialogUI(String nikeName, int bodyPic, int bodyNum) {
		...
		eb.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				DataWR.getFile(Figures.cc.sig.serialize());
				dispose();
		...
		NickName.setBounds(31, 93, 300, 44);
		NickName.setText(nikeName+"【已加密】");
